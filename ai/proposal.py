...
1. السعر المناسب للعرض بالدولار (رقم واحد محدد، ليس نطاق).
...
قواعد التسعير والمدة:
- السعر يجب أن يعكس حجم العمل الحقيقي، وليس الحد الأقصى للميزانية.
- لا تختر السعر الأقصى تلقائياً لمجرد أن العميل يقبله.
- لا تختر أرخص سعر ممكن فقط للفوز.
- الميزانية المعلنة هي سقف، وليست هدفاً.
- إذا كان المشروع صغيراً، اقترح سعراً أقل من الحد الأقصى.
- المدة يجب أن تعكس الجهد الواقعي بما يشمل المراجعة والاختبار.
- لا تختر أسرع مدة ممكنة فقط لإبهار العميل — اختر مدة يمكن تنفيذ العمل بجودة خلالها.
- إذا كان المشروع على نظام قائم، خذ في الاعتبار وقت فهم الكود الموجود.
