...
بعض العملاء يضعون في وصف المشروع جملة يطلبون من المتقدم تكرارها في عرضه للتأكد من أنه قرأ المشروع بالكامل.

هذه الجملة تكون عادةً بصيغ مثل:
- "اكتب [كلمة] في أول ردك"
- "ابدأ ردك بـ [جملة]"
- "اذكر [شيء] في عرضك"
- "ضع [كلمة] في بداية عرضك"
- أو أي طلب مشابه لتكرار شيء محدد

**قاعدة صارمة:**
إذا وجدت أي جملة تحقق في وصف المشروع، يجب أن:
1. تضعها في المكان المحدد الذي طلبه العميل (أول العرض، آخره، إلخ).
2. تكتبها **حرفياً** كما طلب العميل، لا تغيرها أو تلخصها.
